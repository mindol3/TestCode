	...
	<div class="container">
		...
		<script>
			document.addEventListener("DOMContentLoaded", function() {
				...
				//1.팝업을 이용한 Id 중복확인
				//팝업을 띄우는 이유는, 현재 페이지에서 데이터 베이스에 중복 조회를 할려면 페이지 새로고침 이외에는 방법이 없음
				...
				btnIsDuplication2nd.addEventListener('click', function () {
					const id = newMember.id.value;// 아이디 input에 있는 값
					xhr.open('GET', 'ajaxIdCheck.jsp?id=' + id); // HTTP요청 초기화. 통신 방식과 url 설정
